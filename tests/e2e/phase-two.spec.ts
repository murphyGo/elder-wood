...
async function start(page: Page) {
  await page.addInitScript(state => { if (!localStorage.getItem('elderwood-save-v4')) localStorage.setItem('elderwood-save-v4', JSON.stringify(state)); }, { ...newGame(), level: 8, chapter: 4, armor: 3, gold: 1234, hp: 300, mp: 144 });
